...
api = env_exp2.start_play()
state, r, d = next(api)
shape = np.array(state).flatten().shape

agents_exp3 = [Agent(policy="ar")]
agents_exp3.append(Agent())
agents_exp3.append(DQN(state_shape=shape, n_action=10, net=simple_net))
agents_exp3.append(Agent())
...
data_dict = {"exp1": [bg_exp1.agents[0].cum_r, bg_exp1.agents[1].cum_r, bg_exp1.agents[2].cum_r,bg_exp1.agents[3].cum_r],
            ...
            "exp4": [bg_exp4.agents[0].cum_r, bg_exp4.agents[1].cum_r,bg_exp4.agents[2].cum_r,bg_exp4.agents[3].cum_r]}


file = open("./data/savedata.pickle", "wb")
